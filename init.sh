...
export RESOURCE_GROUP_NAME=diagnostic-laboratory-$RANDOM
export AKS_NAME=diagnostic-laboratory
export ACR_NAME=diagnosticLaboratory$RANDOM
...
sed -i '' 's+!IMAGE!+'"$ACR_NAME"'/diagnostic-laboratory+g' kubernetes/deployment.yaml
